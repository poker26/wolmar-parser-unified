...
async function main() {
    ...
    for (const lot of lots) {
        ...
        const result = await pool.query(
            `INSERT INTO auction_lots
               (source_site,source_category,lot_number,source_url,winning_bid,currency,condition,
                coin_description,avers_image_url,year,lot_status,category,parsing_method,
             ...
             VALUES ('auction.ru','auction.ru-coins',$1,$2,$3,'RUB',$4,$5,$6,$7,$8,'auction.ru',
                     'aru-catalog-observation',$9,$10,$11,$12,$13,$14,$15)
            ...
            [
                ...
                lot.n_photos > 0 ? photoUrl(lot.offer_id) : null,
        ...
        const key = staged.staged ? 'candidate' : 'unmatched';

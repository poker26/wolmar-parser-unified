...
class CollectionItemService {
        ...
        try {
            const result = await this.pool.query(
                ...
                [
                    ...
                    input.userLabel, input.gradeSystem, input.gradeCode, input.purchasePriceMinor,
    ...
    async patch(userId, itemId, changes) {
        ...
        try {
            ...
            if (['typeId', 'issueId', 'identifiedYear', 'gradeSystem', 'gradeCode'].some((field) => Object.hasOwn(changes, field))) {

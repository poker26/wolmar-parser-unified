...
async function fetchStealthAdvanced(categoryId = '252', finished = true) {
  console.log('🥷 Using advanced stealth mode with puppeteer-extra...');
  ...
  console.log('⏳ Using advanced stealth mode...');
  ...
  try {
    ...
    const filename = `stealth_advanced_good${categoryId}_opt${finished ? '2' : '1'}_${timestamp}.html`;
    ...
    if (lotLinks > 0) {
      console.log('🎉 Successfully obtained auction data with advanced stealth!');
...
fetchStealthAdvanced(categoryId, finished);

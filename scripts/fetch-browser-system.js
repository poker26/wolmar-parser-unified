...
async function fetchWithSystemBrowser(categoryId = '252', finished = true) {
    console.log('🌐 Using system browser approach...');
    ...
    try {
        ...
        const filename = `system_browser_good${categoryId}_opt${finished ? '2' : '1'}_${timestamp}.html`;
        ...
        if (itemLinks > 0) {
            console.log('🎉 Successfully obtained auction data with system browser!');
...
fetchWithSystemBrowser(categoryId, finished);

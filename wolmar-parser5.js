/**
 * Wolmar Auction Parser v5.0
 * 
 * Основные улучшения в версии 5:
 * - Улучшенное извлечение состояний с градациями (MS61, PF64RB, AU55 и т.д.)
 * - Поддержка сложных форматов состояний (PF 70 ULTRA CAMEO, MS 64RB)
 * - Автоматическое удаление пробелов для унификации состояний
 * - Улучшенная обработка ошибок и восстановление соединений
